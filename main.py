...
root = Tk()
root.title("Employee Registration System (SAKTHI SUGARS LTD)")
...
label = Label(root, text="Employee Registration System (SAKTHI SUGARS LTD)", font=('Arial Bold', 25))
label.grid(row=0, column=0, columnspan=8, rowspan=2, padx=50, pady=40)

studidLabel = Label(root, text="Employee ID", font=('Arial', 15))
...
my_tree['columns'] = ("Employee ID","Firstname","Lastname","Address","Phone")

my_tree.column("#0", width=0, stretch=NO)
my_tree.column("Employee ID", anchor=W, width=170)
